...
public class ComponentFactory {
	 ...
	 */
	public IClientCli createClient(String componentName, InputStream in, PrintStream out) throws Exception {
		/*
	 ...
	 *             if an exception occurs
	 */
	public IChatserverCli createChatserver(String componentName, InputStream in, PrintStream out) throws Exception {
		/*
